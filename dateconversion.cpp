...
#include "QMessageBox"
dateconversion::dateconversion(QWidget *parent) :
    QMainWindow(parent)
{
}
int dateconversion::is_leap_year(int year)
{
    int a =  year;
        if (a%100==0)
                    {
...
QString dateconversion::cnvToNepali(int yy,int mm,int dd)
{
    int  BS[91][13]={
       ...
       int month[12]={31,28,31,30,31,30,31,31,30,31,30,31};
        ...
        if( yy<1944 ||  yy>2033){
           QMessageBox::information(this,"ERROR","1,Supported only between 1944-2033",QMessageBox::Ok);
           yr = 0;

        }
        if( mm<1 ||  mm >12){
           QMessageBox::information(this,"ERROR","2,Error in month value 1-12, Are you looking for jupiter's calender?",QMessageBox::Ok);
            mth= 0;
    return 0;
        }
        if( dd<1 ||  dd >31){
           QMessageBox::information(this,"ERROR","3:Error in day value",QMessageBox::Ok);
            dy = 0;
            return 0;
...
QString dateconversion::get_nepali_month(int m)
{
...
QString dateconversion::get_day_of_week(int d)
{
    QString day;
        switch(d){
                    case 1:
